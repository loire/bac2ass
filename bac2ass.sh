...
/home/bin/bwa/last/x64/bwa mem -M -t 1 ./indexVector_Cont/$(basename $3)  ./tmp/${base}_q$4_R1.fastq > ./mapVectorCont/${base}_tmp_1.sam
...
/home/bin/bwa/last/x64/bwa mem -M -t 1 ./indexVector_Cont/$(basename $3)  ./tmp/${base}_q$4_R2.fastq > ./mapVectorCont/${base}_tmp_2.sam
